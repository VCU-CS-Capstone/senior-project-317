...
class AddBeaconViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func unwindToAddBeacon(sender: UIStoryboardSegue) {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let beaconData = major.text! + ":" + minor.text!
        self.ref.child("claimedBeacons").child(beaconData).setValue(true)
        ...
        appDelegate.beaconsSaved.append(beacon!)
    }
